...
Future<Pages> PagesData(langcode) async {
  final response = await http
      .get(Uri.parse('https://up.ctown.jo/api/pages.php?id=30&lang_code=$langcode'));
...
class ReturncancelScreen extends StatefulWidget {
  //PrivacyScreen({Key key}) : super(key: key);
  final arguments;
  ReturncancelScreen(this.arguments);
  @override
...
@override
class _PrivacyState extends State<ReturncancelScreen> {
  Future<Pages>? pages;
