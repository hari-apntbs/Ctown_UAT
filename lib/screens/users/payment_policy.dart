...
Future<Pages> PagesData(langcode) async {
  final response = await http
      .get(Uri.parse('https://up.ctown.jo/api/pages.php?id=32&lang_code=$langcode'));
...
class PaymentpolicyScreen extends StatefulWidget {
  ...
  final arguments;
  PaymentpolicyScreen(this.arguments);
  @override
...
@override
class _PrivacyState extends State<PaymentpolicyScreen> {
  Future<Pages>? pages;
