...
Future<Pages> PagesData(langcode) async {
  final response = await http
      .get(Uri.parse('https://up.ctown.jo/api/pages.php?id=24&lang_code=$langcode'));
...
class PrivacypolicyScreen extends StatefulWidget {
  ...
  final arguments;
  PrivacypolicyScreen(this.arguments);
  @override
...
@override
class _PrivacyState extends State<PrivacypolicyScreen> {
  Future<Pages>? pages;
