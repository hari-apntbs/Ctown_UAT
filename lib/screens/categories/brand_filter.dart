...
class Brandfilter extends StatefulWidget {
  ...
  const Brandfilter({Key? key, this.categoryid, this.optionid}) : super(key: key);
...
class _BrandfilterState extends State<Brandfilter>
  ...
  _loadProduct() async {
    ...
    if (selectedCategory.isNotEmpty) {
        ...
        newProducts.addAll(await MagentoApi().brandfilter(
          widget.categoryid,_page,widget.optionid, langCode
        ));
    ...
    if (newProducts.isEmpty || _page > 20) {
      setState(() {
        canLoad = false;
      });
    }
