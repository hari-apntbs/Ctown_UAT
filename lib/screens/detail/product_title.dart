...
class ProductTitle extends StatefulWidget {
  ...
  ProductTitle(this.product, this.value, this.productprice, this.defaultprice,
      this.saleprice, this.onSale, this.isProductCard);
...
class _ProductTitleState extends BaseScreen<ProductTitle> {
  ...
  getProductPrice() {
    try {
      ...
      if (onSale!) {
        price = productVariation != null
            ? double.parse(productVariation!.price!) >
                    double.parse(productVariation!.salePrice!)
        ...
        InkWell(
          ...
          child: Wrap(
            children: <Widget>[
                      ...
                      children: [
                        Text(
                          widget.value!.isNotEmpty
                              ? widget.onSale![0] == true
                                  ?
                                  // "${Tools.getCurrencyFormatted(widget.productprice ?? widget.defaultprice, currencyRate, currency: currency) + "  " + "Per" + "  " + widget.value}",
                                  widget.value!.isNotEmpty
                                      ? "${Tools.getCurrencyFormatted(widget.saleprice ?? widget.defaultprice ?? "0.0", currencyRate, currency: currency)} per ${widget.value}"
                                      : '1 KG'
                                  : widget.value!.isNotEmpty
                                      ? "${Tools.getCurrencyFormatted(widget.defaultprice ?? "0.0", currencyRate, currency: currency)} per ${widget.value}"
                                      : '1 KG'
                              : '1 KG',
                          style: Theme.of(context).textTheme.titleMedium!.copyWith(
                                fontSize: 14,
                        ...
                        widget.value!.isNotEmpty && widget.isProductCard == false && false
                            ? Expanded(
                                child: Row(
                                  children: [
                                    const SizedBox(width: 6),
                                    if (widget.onSale![0] == true)
                                      Text(
                                    ...
                                    if (widget.onSale![0] == true)
                                      Container(
                                        ...
                                        child: Text(
                                          S.of(context).sale(
                                              '${sale = (100 - (double.parse(widget.saleprice!) / double.parse(widget.defaultprice!)) * 100).toInt()}'),
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleSmall!
                                              .copyWith(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                widget.value!.isNotEmpty &&
                                    ...
                                    : Container(),
                                if ((kSaleOffProduct["ShowCountDown"] as bool? ??
                                        false) &&
                                    dateOnSaleTo != null &&
                                    countDown > 0) ...[
                                  const Spacer(),
              ...
              //         ),
              //       ),
              //       if ((kSaleOffProduct["ShowCountDown"] ?? false) &&
              //           dateOnSaleTo != null &&
              //           countDown > 0) ...[
              //         const Spacer(),
              //         Padding(
              ...
              //   ),
              //
              // widget.value.isNotEmpty && widget.product.type == 'configurable'
              //     ? Row(
              //         crossAxisAlignment: CrossAxisAlignment.center,
              //         children: <Widget>[
              //           Container(
