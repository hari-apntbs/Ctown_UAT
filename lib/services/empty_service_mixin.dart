...
mixin EmptyServiceMixin implements BaseServices {
  ...
  Future<Order?> createOrder(
      {CartModel? cartModel,
        UserModel? user,
        bool? paid,
        ClickNCollectProvider? clickNCollectProvider}) async {
    return null;
  }
  ...
  @override
  Future<void>? addAddress(Address address, User? user,String? lang,String? lati,String? lan) => null;

  @override
  Future<void>? editAddress(Address address, User? user,String? lang,String? lat,String? lan) => null;

  @override
  Future<List<String>>? getProductAddtionalInfo(productId) => null;
}
