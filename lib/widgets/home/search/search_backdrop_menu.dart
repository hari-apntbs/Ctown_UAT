...
import '../../backdrop/category_item.dart';
import '../../backdrop/filter_option_item.dart';

class SearchBackdropMenu extends StatefulWidget {
  final Function? onFilter;
  final List<String>? categoryIdList;
  final String? tagId;
  final String? searchStr;

  const SearchBackdropMenu({
    Key? key,
    this.onFilter,
    this.categoryIdList,
    this.tagId,
  ...
  @override
  _SearchBackdropMenuState createState() => _SearchBackdropMenuState();
}

class _SearchBackdropMenuState extends State<SearchBackdropMenu> {
  double mixPrice = 0.0;
  ...
  _getCategoryList() async {
    categoryLists = MagentoApi().getSearchCategoryList(widget.searchStr,
  ...
  // Parent _buildExpandableCategory(Category item, CategoryModel catModel, int level) {
  //   return Parent(
  //     parent: CategoryItem(
  //       item,
    ...
    return Padding(
      ...
      child: ButtonTheme(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            onPressed();
            Tools.showSnackBar(ScaffoldMessenger.of(context), S.of(context).clear);
          },
