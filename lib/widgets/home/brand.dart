...
class Brand extends StatefulWidget {
  ...
  const Brand({Key? key, this.config}) : super(key: key);
...
class _BrandState extends State<Brand>
  ...
  _loadProduct() async {
    ...
    if (selectedCategory.isNotEmpty) {
        ...
        newProducts.addAll(await MagentoApi().brand(
          
          widget.config,_page,Provider.of<AppModel>(context, listen: false).langCode,
        ));
