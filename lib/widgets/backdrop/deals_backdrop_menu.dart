...
class DealsBackdropMenu extends StatefulWidget {
  final Function? onFilter;
  final List<String>? categoryIdList;
  final String? tagId;

  const DealsBackdropMenu({
    Key? key,
    this.onFilter,
    this.categoryIdList,
    this.tagId,
  ...
  @override
  _DealsBackdropMenuState createState() => _DealsBackdropMenuState();
}

class _DealsBackdropMenuState extends State<DealsBackdropMenu> {
  double mixPrice = 0.0;
